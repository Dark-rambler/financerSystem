...
const RegisterDepositOrder = () => {
  ...
  return (
    <div className='h-full w-full px-64 py-10'>
      <div className='relative flex'>
        <ActionIcon className='absolute left-[-50px]' size={'md'} onClick={() => {navigate(-1)}}>
            <TbChevronLeft />
        </ActionIcon>
      ...
      <div className='pt-10 grid grid-cols-2 h-full pb-20'>
        ...
        <Stack className=' px-24 border-l border-gray-300 h-full' spacing={20}>
