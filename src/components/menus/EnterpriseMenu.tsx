  ...
  return (
    <>
      <Menu shadow='sm' width={175}>
        <Menu.Target>
          {isTechoBol ? (
            <div className='flex justify-center space-x-2 w-[175px] bg-white hover:bg-gray-100 p-2 hover:cursor-pointer rounded-md'>
              {' '}
              <img
        ...
        <Menu.Dropdown>
          ...
          >
            {isTechoBol ? (
              <div className='flex justify-center space-x-2 w-[140px] p-2 hover:cursor-pointer rounded-md'>
                {' '}
                <img src='/images/megadisLogo.png' width={35} alt='alt' />
                <p className=' text-slate-900 font-bold text-[16px]'>Megadis</p>
              </div>
