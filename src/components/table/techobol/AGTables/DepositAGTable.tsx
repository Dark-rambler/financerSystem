...
interface DepositProps {
  data: IDeposit[]
  gridRef: React.MutableRefObject<AgGridReact<IDeposit> | null>
}

const DepositAGTable = ({ data, gridRef }: DepositProps) => {
  const [rowData, setRowData] = useState<IDeposit[]>(data)
